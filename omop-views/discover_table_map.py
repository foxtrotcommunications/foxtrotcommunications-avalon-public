...
REQUIRED_PATHS = {
    "patient": {
        "raw": "root",
        "extension": "root__extension",
        "extension.extension": "root__extension__extension",
        "extension.extension.valueCoding": "root__extension__extension__valueCoding",
    },
    "encounter": {
        "raw": "root",
        "class": "root__class",
        "period": "root__period",
        "participant": "root__participant",
        "participant.individual": "root__participant__individual",
        "subject": "root__subject",
        "hospitalization": "root__hospitalization",
        "hospitalization.admitSource": "root__hospitalization__admitSource",
        "hospitalization.admitSource.coding": "root__hospitalization__admitSource__coding",
        "hospitalization.dischargeDisposition": "root__hospitalization__dischargeDisposition",
        "hospitalization.dischargeDisposition.coding": "root__hospitalization__dischargeDisposition__coding",
    },
    "condition": {
        "raw": "root",
        "code": "root__code",
        "code.coding": "root__code__coding",
        "subject": "root__subject",
        "encounter": "root__encounter",
    },
    "procedure": {
        "raw": "root",
        "code": "root__code",
        "code.coding": "root__code__coding",
        "performedPeriod": "root__performedPeriod",
        "subject": "root__subject",
        "encounter": "root__encounter",
    },
    "observation": {
        ...
        "code": "root__code",
        "code.coding": "root__code__coding",
        "valueQuantity": "root__valueQuantity",
        "subject": "root__subject",
        "encounter": "root__encounter",
    },
    "medication_request": {
        "raw": "root",
        "medicationCodeableConcept": "root__medicationCodeableConcept",
        "medicationCodeableConcept.coding": "root__medicationCodeableConcept__coding",
        "subject": "root__subject",
        "encounter": "root__encounter",
        "dosageInstruction": "root__dosageInstruction",
        "dosageInstruction.route": "root__dosageInstruction__route",
        "dosageInstruction.route.coding": "root__dosageInstruction__route__coding",
    },
}
    ...
    for resource_key in target_resources:
        ...
        for table_name in table_names:
            ...
            try:
                ...
                # root won't have table_path as a queryable value
                # in the same way — handle gracefully
                if table_name == "root":
                    resource_map["root"] = "root"
                else:
        ...
        for semantic_key, expected_path in required.items():
            if semantic_key == "raw":
                ...
                # Find the table whose path is root
                candidates = [
                    tn for tn in table_names
                    if tn.startswith("root__") and tn.count("__") == 2
                ]
                if candidates:
                    resolved[semantic_key] = candidates[0]
                else:
                    resolved[semantic_key] = "root__raw_1"  # default
