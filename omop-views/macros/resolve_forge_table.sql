...
{#
  ...
  3. Default convention — root__raw_1__<4char><rank>

  Usage:
    {{ resolve_forge_table('forge_patient', 'extension', 'patient') }}
    → returns the actual table name string, e.g. "root__raw_1__exte1"
...
{% if execute %}
  {% set fhir_path_map = {
    ...
    'ext_ext':       'root__extension__extension',
    'ext_ext_val':   'root__extension__extension__valueCoding',
    'class':         'root__class',
    'period':        'root__period',
    'participant':   'root__participant',
    'part_indiv':    'root__participant__individual',
    'subject':       'root__subject',
    'encounter':     'root__encounter',
    'code':          'root__code',
    'code_coding':   'root__code__coding',
    'performed':     'root__performedPeriod',
    'value':         'root__valueQuantity',
    'med_concept':   'root__medicationCodeableConcept',
    'med_coding':    'root__medicationCodeableConcept__coding',
  } %}
