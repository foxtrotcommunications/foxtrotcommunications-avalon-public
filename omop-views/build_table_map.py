...
Each entry has:
  - model_name: actual table name (e.g. "root__root__raw_1__exte1")
  - table_path: canonical FHIR path (e.g. "root__root__extension")
  - depth: nesting level
"""
...
PATH_TO_KEY = {
    # Patient
    "root__root__extension":                             ("patient", "extension"),
    "root__root__extension__extension":                  ("patient", "ext_ext"),
    "root__root__extension__extension__valueCoding":     ("patient", "ext_ext_val"),
    # Encounter
    "root__root__class":                                 ("encounter", "class"),
    "root__root__period":                                ("encounter", "period"),
    "root__root__participant":                           ("encounter", "participant"),
    "root__root__participant__individual":               ("encounter", "part_indiv"),
    "root__root__subject":                               ("encounter", "subject"),
    # Condition
    "root__root__code":                                  ("condition", "code"),
    "root__root__code__coding":                          ("condition", "code_coding"),
    # Also used by: procedure, observation
    # Procedure
    "root__root__performedPeriod":                        ("procedure", "performed"),
    # Observation
    "root__root__valueQuantity":                          ("observation", "value"),
    # MedicationRequest
    "root__root__medicationCodeableConcept":              ("medication_request", "med_concept"),
    "root__root__medicationCodeableConcept__coding":      ("medication_request", "med_coding"),
    # Claim
    "root__root__billablePeriod":                         ("claim", "billable_period"),
    "root__root__provider":                               ("claim", "provider"),
    "root__root__patient":                                ("claim", "patient"),
    "root__root__facility":                               ("claim", "facility"),
    "root__root__priority":                               ("claim", "priority"),
    "root__root__priority__coding":                       ("claim", "priority_coding"),
    "root__root__item":                                   ("claim", "item"),
    "root__root__item__encounter":                        ("claim", "item_encounter"),
    "root__root__item__net":                              ("claim", "item_net"),
    "root__root__item__productOrService__coding":         ("claim", "item_product_coding"),
    # EOB
    "root__root__insurer":                                ("eob", "insurer"),
    "root__root__total":                                  ("eob", "total"),
    "root__root__total__amount":                          ("eob", "total_amount"),
    "root__root__payment":                                ("eob", "payment"),
    "root__root__payment__amount":                        ("eob", "payment_amount"),
}

# Shared paths (same FHIR path, different resource contexts)
SHARED_PATHS = {
    "root__root__subject":       [("encounter", "subject"), ("condition", "subject"),
                                  ("procedure", "subject"), ("observation", "subject"),
                                  ("medication_request", "subject")],
    "root__root__encounter":     [("condition", "encounter"), ("procedure", "encounter"),
                                  ("observation", "encounter"), ("medication_request", "encounter")],
    "root__root__code":          [("condition", "code"), ("procedure", "code"),
                                  ("observation", "code")],
    "root__root__code__coding":  [("condition", "code_coding"), ("procedure", "code_coding"),
                                  ("observation", "code_coding")],
    "root__root__patient":       [("claim", "patient"), ("eob", "patient")],
}
